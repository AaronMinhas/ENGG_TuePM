...
void SafetyManager::begin()
{
    ...
    m_eventBus.subscribe(BridgeEvent::BOAT_DETECTED, [this](EventData* data) { this->onEvent(data); });
    m_eventBus.subscribe(BridgeEvent::TRAFFIC_STOPPED_SUCCESS, [this](EventData* data) { this->onEvent(data); });
    m_eventBus.subscribe(BridgeEvent::BRIDGE_OPENED_SUCCESS, [this](EventData* data) { this->onEvent(data); });
    m_eventBus.subscribe(BridgeEvent::BOAT_PASSED, [this](EventData* data) { this->onEvent(data); });
    m_eventBus.subscribe(BridgeEvent::BRIDGE_CLOSED_SUCCESS, [this](EventData* data) { this->onEvent(data); });
    m_eventBus.subscribe(BridgeEvent::TRAFFIC_RESUMED_SUCCESS, [this](EventData* data) { this->onEvent(data); });
    m_eventBus.subscribe(BridgeEvent::FAULT_DETECTED, [this](EventData* data) { this->onEvent(data); });
